...
public class Input {
    ...
    // -------------------------------------------------
    // default key codes
    // will vary when you let the user customize the key codes or add support for a 2nd player
    // -------------------------------------------------
    ...
    private KeyCode challenge = KeyCode.ENTER;
    private KeyCode inventory = KeyCode.Q;
    ...
    // If direction & opposite direction are pressed simultaneously, then direction isn't handled
    // -------------------------------------------------
    ...
    public boolean isChallenge() {
        return keyboardBitSet.get(challenge.ordinal());
    }
